...
//
//class MovieCallBack<R: BaseResponse, D: BaseNetworkDelegate>(var delegate: D): Callback<R> {
//
//
//    override fun onFailure(call: Call<R>, t: Throwable) {
//        delegate.onFail(t.hashCode(), t.message!!)
//    }
//
...
//
//            delegate.onFail(1, "Response is null")
//            return
//        }else
//        {
//
